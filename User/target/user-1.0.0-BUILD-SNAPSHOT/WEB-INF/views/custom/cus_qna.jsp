			...
			<div id="content" class="page-counsel">
				...
				<ul class="counsel-list">
					...
					<li class="list2"><a href="#"
						onclick="openPopCounsel('popCounselEmail', this)"> <strong><span>이메일</span>상담</strong>
				...
				<div id="popCounselTelOverlay" class="modal-overlay"
					style="width: 1306px; height: 1305px; display: none;"></div>
				<div id="popCounselTel" class="pop-modal3"
					style="top: 86px; margin-left: -295px;">
					<div class="header">
						<h2>전화 상담예약</h2>
							...
							<dl>
								...
								<dd class="wrap">
									...
									<input type="text" class="text" id="applyUserName" title="신청날짜"
										style="ime-mode: active;" maxlength="30" name="regidate" value="${str }" />
								</dd>
							</dl>
							...
							<dl>
								...
								<dd class="wrap">
									<div class="form-telnum">
										<span class="select-box"> <select title="연락처(앞자리)"
											id="telNum1">
												<option>010</option>
												<option>011</option>
												<option>016</option>
										...
										<div class="form-wrap1">
											<label for="telNum2" class="label">-없이 번호만 입력해주세요.</label> <input
												maxlength="8" type="text" id="telNum2"
												class="text placeholder numOnly">
										</div>
									</div>
								</dd>
							</dl>
								...
								<dd class="wrap">
									<div class="form-wrap2">
										<div class="form-wrap1">
											...
											</label> <span class="form-date"> <input maxlength="8"
												type="text" id="telYear1"
												class="text placeholder hasDatepicker valueon"
												title="1순위 예약시간 날짜 : 예) 20160101 (네자리년도/두자리월/두자리일)"
												readonly="">
												<button type="button" class="ui-datepicker-trigger"
													style="text-indent: -9999em; width: 38px; height: 39px;">
													달력으로 선택<span style="left: 2px; top: 2px;"></span>
												</button>
											</span>
										</div>
										<span class="select-box"> <select id="telStartTime1"
											title="1순위 예약시간 시작시간(단위:시)">
												<option>09</option>
												<option>10</option>
												<option>11</option>
												<option>12</option>
										...
										</span> <span>시~ </span> <span id="telEndTime1" class="select-box">
											<select title="1순위 예약시간 종료시간(단위:시)">
												<option>10</option>
												<option>11</option>
												<option>12</option>
												<option>13</option>
										...
										<button onclick="addTel()" class="btn-type2 c2">
											<span>추가</span><span class="hd">(클릭하시면 2순위 예약시간 및 날짜를
												추가입력하실 수 있습니다.)</span>
										</button>
									</div>
									<div class="form-wrap2" id="addTel" style="display: none">
										<div class="form-wrap1">
											<label for="telYear2" class="label">예) <script
													type="text/javascript">
												document.write(year + month	+ day);
											</script>20180902
											</label> <span class="form-date"> <input type="text"
												id="telYear2" class="text placeholder hasDatepicker"
												title="2순위 예약시간 날짜 : 예) 20160101 (네자리년도/두자리월/두자리일)"
												readonly="">
												<button type="button" class="ui-datepicker-trigger"
													style="text-indent: -9999em; width: 38px; height: 39px;">
													달력으로 선택<span style="left: 2px; top: 2px;"></span>
										...
										<span class="select-box"> <select id="telStartTime2"
											title="2순위 예약시간 시작시간(단위:시)" disabled="disabled">
												<option>09</option>
												<option>10</option>
												<option>11</option>
												<option>12</option>
										...
										</span> <span>시~ </span> <span class="select-box"> <select
											id="telEndTime2" title="2순위 예약시간 종료시간(단위:시)"
											disabled="disabled">
												<option>10</option>
												<option>11</option>
												<option>12</option>
										...
										<button onclick="removeTel()" class="btn-type2 c2">
											<span>제거</span><span class="hd">(클릭하시면 2순위 예약시간 및 날짜를
												제거 하실 수 있습니다.)</span>
										</button>
									</div>
								</dd>
							...
							<dl class="block">
								...
								<dd class="wrap">
									<div class="form-wrap1 textform">
										<label for="applyCounselMemo2" class="label">상담에 대한
											간략한 내용과 함께 문의가 필요한 보험상품과<br>본인 정보등을 함께 작성해 주시면, 보다 빠른
											상담이 가능합니다.
										</label>
										<textarea rows="4" cols="20" id="applyCounselMemo2"
											class="textarea placeholder valueon"
											title="문의내용(2000자까지 입력가능)" maxlength="2000"
											onkeyup="checkByte2(this, '2000', 'applyCounselMemoLength2')"
							...
							<fieldset>
								...
								<div class="box-scroll" tabindex="0">
									<div class="con-policy">
										...
										<p>당사는 개인정보보호법에 따라 본 서비스와 관련하여 고객님의 개인 정보를 다음과 같이 수집/이용하고자
											합니다.</p>
										...
										<p>동의일로부터 1년</p>
										<p>고객님이 삼성생명보험주식회사에 대하여 '별도의 개인(신용)정보에 관한 동의'를 한 경우 (금융거래
											등 상거래의 체결 유지 관리 목적 등)로서 해당 동의목적으로 위 개인정보가 수집 및 이용되는 경우에는 해당
											동의에 따른 보유 및 이용기간이 적용됩니다.</p>
									</div>
								</div>
								<div class="btn">
									<span class="label-radio"> <label
										for="telCounselAgreechk1" class="on">동의함</label> <input
										type="radio" name="telCounselAgreeCheck" class="radio"
										id="telCounselAgreechk1" checked="checked"
										title="개인정보를 위한 이용자 동의사항 동의함">
									</span> <span class="label-radio"> <label
										for="telCounselAgreechk2">동의하지 않음</label> <input type="radio"
										name="telCounselAgreeCheck" class="radio"
										id="telCounselAgreechk2" title="개인정보를 위한 이용자 동의사항 동의하지 않음">
									</span>
								</div>
							</fieldset>
						</div>
					...
					<div class="content">
						...
						<fieldset class="form-content3">
							...
							<dl class="block">
								...
								<dd class="wrap">
									<div class="form-wrap1 textform">
										<label for="popEmailapplyCounselMemo" class="label">상담에
...
- 문의내용 :
						...
						<div class="form-agree3">
							<fieldset>
								...
								<div class="btn">
									<span class="label-radio"> <label for="counselAgreechk1"
										class="on">동의함</label> <input type="radio" name="mailAgree"
										class="radio" id="counselAgreechk1" checked="checked"
										title="개인정보 수집 및 이용에 관한 동의 동의함" />
									</span> <span class="label-radio"> <label
										for="counselAgreechk2">동의하지 않음</label> <input type="radio"
										name="mailAgree" class="radio" id="counselAgreechk2"
										title="개인정보 수집 및 이용에 관한 동의 동의하지 않음" />
									</span>
								</div>
							</fieldset>
						</div>
