		...
		<div id="container">
			...
			<div id="content" class="page-counsel">
				...
				<ul class="counsel-list">
					...
					<li class="list3"><a href="#" onclick="openPopCounsel('remote');"> <strong><span>1:1문의</span>요청</strong> <em name="remoteStatus" class="icon-state on">ON</em>
					</a></li>
				</ul>
				<p class="mes-type1">
					...
					<div class="content">
						...
						<fieldset class="form-content3">
							...
							<dl>
								...
								<dd class="wrap">
									<input type="text" class="text" id="customerName" maxlength="30" title="신청인 이름" style="ime-mode: active;">
								</dd>
							</dl>
							<!--
			<dl>
				<dt class="heading"><span class="label">생년월일</span></dt>
				<dd class="wrap">
					<div class="form-wrap1">
						<label for="birthDay" class="label">예) 19851015</label>
						<span class="form-date">
							<input maxlength="8" type="text" id="birthDay" class="text placeholder" title="생년월일 예) 19851015 (네자리년도/두자리월/두자리일)" />
						</span>
					</div>
				</dd>
			</dl>
			-->
							...
							<dl>
								...
								<dd class="wrap">
									...
									<!--<div class="txt-sub">
						<p class="txt-type2">평일 08시 30분부터 17시 30분까지 전문상담원과의 상담서비스를 이용할 수 있습니다.</p>
					</div>-->
								</dd>
							</dl>
							<dl class="block">
				...
				<div id="popCounselEmail" class="pop-modal3">
					...
					<div class="content">
						...
						<fieldset class="form-content3">
							...
							<dl>
								<dt class="heading">
									<label for="applyUserName">작성자</label>
								</dt>
								<dd class="wrap">
							...
							<dl>
								<dt class="heading">
									<label for="applyUserMobile">모바일</label>
								</dt>
								<dd class="wrap">
									<div>
										<input type="text" class="text" id="applyUserMobile" title="모바일" style="ime-mode: active;" maxlength="30" /> <span class="unit">-</span> <input type="text" class="text" id="applyUserMobile" title="모바일" style="ime-mode: active;" maxlength="30" /> <span class="unit">-</span> <input type="text" class="text" id="applyUserMobile" title="모바일" style="ime-mode: active;" maxlength="30" />
									</div>
								</dd>
							</dl>
							<dl>
								...
								<dd class="wrap">
									<div class="form-email">
										<input type="text" class="text" id="applyUserEmail1" title="이메일아이디" style="ime-mode: disabled;" /> <span class="unit">@</span> <input type="text" class="text " id="applyUserEmail2" title="이메일도메인" style="ime-mode: disabled;" /> <span class="select-box"> <select title="이메일도메인 선택" id="popEmailCombobox">
												<option>직접입력</option>
						...
						<!-- # 하단버튼 # -->
						<div class="btn-area">
							<a href="#none" class="btn-type2 ui-close"><span>취소</span></a> <a href="#none" class="btn-type2 c1" id="sendEmailCounsel" onclick="ga('send','event','Direct','Etc','Rightside-Navi_email_done',1);"><span>상담신청</span></a>
						</div>
					</div>
				</div>
			</div>
