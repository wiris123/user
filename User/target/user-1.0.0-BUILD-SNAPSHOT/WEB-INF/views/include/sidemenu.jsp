...
<div id="popCounselonebyone" class="pop-modal3">
					<div class="header">
						...
						<button type="button" class="ui-close">
							1:1 문의요청 닫기<span></span>
						</button>
					</div>
					<div class="content">
						<!-- # 상담신청입력폼 # -->
						<h3 class="mes-top">이메일 주소와 상담하실 내용을 입력해 주세요.</h3>
						<form id="form" src="/user/custom/sendonebyone" method="post" action="<%=request.getContextPath() %>/custom/onebyoneTest.do">
					...
					<div class="content">
						...
						<fieldset class="form-content3">
							...
							<dl>
								...
								<dd class="wrap">
									<input type="text" class="text" id="applyUserName" title="신청인 이름" style="ime-mode: active;" maxlength="30" name="name"> &nbsp; <span class="heading"><label for="applyUserName">작성일</label></span> <input type="text" class="text" id="applyUserName" title="신청날짜" style="ime-mode: active;" maxlength="30" name="regidate" value="18/09/11">
								</dd>
							</dl>
								...
								<dd class="wrap">
									<div class="form-wrap2">
										<div class="form-wrap1">
											...
											</label> <span class="form-date"> <input maxlength="8" type="text" id="telYear1" class="text placeholder hasDatepicker" title="1순위 예약시간 날짜 : 예) 20160101 (네자리년도/두자리월/두자리일)" readonly="">
