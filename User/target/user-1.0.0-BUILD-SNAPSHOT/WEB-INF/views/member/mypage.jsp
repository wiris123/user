...
<body>
   <div id="wrapper">
      ...
      <div id="container"> 
         ...
         <!-- ## 탭영역 ## -->
         <ul class="tab-type1"><!-- @2015-12-14 : tab-type1로 클래스명 변경 -->
         ...
         <div class="box-content2">
            ...
            <div class="info-personal">
               ...
               <h2 class="heading"><strong>배재현</strong> 고객님 기본정보 <a href="/logout.eds" class="btn-type4 logout"><span>본인인증 종료</span></a></h2>
