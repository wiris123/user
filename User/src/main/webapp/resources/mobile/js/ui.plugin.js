...
;(function($){
	...
	$.fn.bxSlider = function(options){
		...
		el.goToSlide = function(slideIndex, direction){
			...
			slider.settings.onSlideBefore(slider.children.eq(slider.active.index), slider.oldIndex, slider.active.index, slider);
			if(direction == 'next'){
		...
		el.destroySlider = function(){
			...
			if(!slider.settings.pagerCustom && slider.pagerEl && slider.settings.controls) slider.pagerEl.remove();	//@2016-02-16 버그수정
