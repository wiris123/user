		...
		<div id="container">
			...
			<div id="content">
                ...
                <ul class="counsel-list">
                    <li class="list1">
                        <a href="#" onclick="openPopCounsel('chat');">
                            <strong><span>채팅</span>상담</strong>
                            <em name="chatStatus" class="icon-state off">OFF</em>
                        </a>
                    </li>
                    <li class="list2">
                        <a href="#" onclick="openPopCounsel('email', this)">
                            <strong><span>이메일</span>상담</strong>
                            <em name="emailStatus" class="icon-state on">ON</em>
                        </a>
                    </li>
                    <li class="list3">
                        <a href="#" onclick="openPopCounsel('remote');">
                            <strong><span>원격지원</span>요청</strong>
                            <em name="remoteStatus" class="icon-state off">OFF</em>
                        </a>
                    </li>
                </ul>
                <p class="mes-type1">
