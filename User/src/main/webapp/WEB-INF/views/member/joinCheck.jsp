...
제 2조 (정의)
홈페이지란 삼성생명주식회사가 컴퓨터 등 정보통신설비를 이용하여 재화 또는 용역을 이용자에게 제공하고 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 홈페이지를 운영하는 사업자의 의미로도 사용합니다.
...
보험·대출 등 삼성생명이 취급하는 금융상품의 설명, 안내(e-mail 발송 등), 가상설계, 가입·환매신청
삼성생명과 보험계약, 대출 및 펀드 등의 거래가 있는 이용자를 위한 금융거래내역의 조회 및 입출금 서비스 등 홈페이지 금융거래 서비스의 운영 (다만, 홈페이지 금융거래 서비스를 이용하기 위해서는 별도의 이용신청을 하여야 합니다)
...
기타 개인정보관련 사항은 "삼성생명 홈페이지 이용자에 대한 개인정보처리방침"에 의거합니다.
...
고객님이 삼성생명보험주식회사에 대하여 '별도의 개인(신용)정보에 관한 동의'를 한 경우(금융거래 등 상거래의 체결 유지 관리 목적 등)로서 해당 동의 목적으로 위 개인정보가 수집 및 이용되는 경우에는 해당 동의에 따른 보유 및 이용기간이 적용됩니다.
