      ...
      <div id="container">
         ...
         <div id="content" class="page-counsel">
            ...
            <ul class="counsel-list">
               <li class="list1"><a href="#" onclick="window.open('<%=request.getContextPath() %>/include/chat', 'ISM상담','width=600px, height=800px'); return false"> <strong><span>채팅</span>상담</strong> <em name="chatStatus" class="icon-state on">ON</em>
               </a></li>
