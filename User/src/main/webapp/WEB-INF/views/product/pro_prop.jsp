						...
						<div class="calculator-form">
							...
							<div class="form">
								...
								<input type="hidden" id="napTerm" name="napTerm" value="1" /> <a
									href="#none" class="btn" id="calcPremium" onclick="premCal();"><span>내
										보험료 확인 / 가입</span></a>
							</div>
						</div>
					</fieldset>
									...
									<ul>
										<li data-role="ui-guarantee-disease">
											...
											<div class="select">
												...
												<!-- 상품개정 ui 수정 by syi-->
												<span class="select-box"> <select id="hosp" name="hosp"
													title="상품 선택" onchange="setProType(this);">
										...
										<li data-role="ui-guarantee-disease">
											...
											<div class="select">
												...
												<!-- 상품개정 ui 수정 by syi-->
												<span class="select-box"> <select id="gohosp" name="gohosp"
													title="상품 선택" onchange="setProType(this);">
										...
										<li data-role="ui-guarantee-accident">
											...
											<div class="select">
												...
												<!-- 상품개정 ui 수정 by syi-->
												<span class="select-box"> <select id="sanghosp" name="sanghosp"
													title="상품 선택" onchange="setProType(this);">
										...
										<li data-role="ui-guarantee-accident">
											...
											<div class="select">
												...
												<!-- 상품개정 ui 수정 by syi-->
												<span class="select-box"> <select  id="sgohosp" name="sgohosp"
													title="상품 선택" onchange="setProType(this);">
