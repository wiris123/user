	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div class="product-basic page-change">
				...
				<div class="info">
					<h1>
						<span>ISM</span><strong>인터넷 실손의료비보장보험</strong><em>1.0 (기본형/갱신형/무배당)</em>
					</h1>
					<p class="com1">
						<strong>입원</strong>과 <strong>통원</strong>,<br />
						<strong>질병</strong>과 <strong>상해</strong>에 대비!
					</p>
					<p class="com2">
					...
					<fieldset>
						...
						<div class="calculator-form">
							...
							<div class="form">
								<ul>
									...
									<li>
										<div class="form-wrap1">
											<label for="birthday" class="label">생년월일 <span>(예 : 19851015 )</span></label> <input type="text" autocomplete="off" class="text placeholder numOnly" maxlength="8" id="birthday" />
										</div>
									</li>
									<!-- 성별 -->
									<li>
										<div class="label-radiobtn gender">
											<span> <label for="calcGender1">남자</label> <input type="radio" name="pgender" class="radio" id="calcGender1" value="1" />
											</span> <span> <label for="calcGender2">여자</label> <input type="radio" name="pgender" class="radio" id="calcGender2" value="2" />
											</span>
										</div>
									</li>

									<!-- 보험기간 -->
									<li><span class="select-box" style="display: none;"> <select id="insTerm" title="보험기간">
												<option value="">보험기간 선택</option>
											</select>
									</span></li>
									<li><span class="label-check"> <label for="mdcrRcbfrYn">의료수급권자 여부</label> <input type="checkbox" class="check" id="mdcrRcbfrYn" name="mdcrRcbfrYn" value="Y" title="의료수급권자선택" />
									</span>
								...
								<input type="hidden" id="napTerm" name="napTerm" value="1" /> <a href="#none" class="btn" id="calcPremium"><span>내 보험료 확인 / 가입</span></a>
							</div>
						</div>
					</fieldset>
				</form>
			...
			<div class="product-result open" id="uiProductResult1" style="display: block;" tabindex="0">
				...
				<div class="result-area">
					...
					<div class="list-result thum ui-list-mode">
						<div class="data-case1">
							...
							<div class="box box-result1 on">
								<h4 class="heading">
									<span id="prdtgb"></span> <strong><span>월납</span><span id="monthlyPremium1" data-gtm-vis-recent-on-screen-8355294_25="29377" data-gtm-vis-first-on-screen-8355294_25="29377" data-gtm-vis-total-visible-time-8355294_25="100" data-gtm-vis-has-fired-8355294_25="1">0,000</span>원</strong> <a href="#popProductCart" class="btn-save" id="savePlan1" onclick="ga('send','event','Direct','Etc','Check-info_medical-top_list_1',1);" rel="history">설계저장</a>
								</h4>
								<div class="con">
									...
									<ul>
										<li data-role="ui-guarantee-disease">
											...
											<div class="select">
												...
												<!-- 상품개정 ui 수정 by syi-->
												<span class="select-box"> <select id="selji" title="상품 선택" onchange="setProType(this);">
										...
										<li data-role="ui-guarantee-disease">
											...
											<div class="select">
												...
												<!-- 상품개정 ui 수정 by syi-->
												<span class="select-box"> <select id="seljt" title="상품 선택" onchange="setProType(this);">
										...
										<li data-role="ui-guarantee-accident">
											...
											<div class="select">
												...
												<!-- 상품개정 ui 수정 by syi-->
												<span class="select-box"> <select id="selsi" title="상품 선택" onchange="setProType(this);">
										...
										<li data-role="ui-guarantee-accident">
											...
											<div class="select">
												...
												<!-- 상품개정 ui 수정 by syi-->
												<span class="select-box"> <select id="selst" title="상품 선택" onchange="setProType(this);">
							...
							<div class="box box-result2 on">
								...
								<div class="con">
									...
									<div class="tooltip-area">
										<span class="sub-tit">선택특약</span> <a href="#none" class="icon-tip" style="margin: 10px 0 -8px 6px;" rel="history">안내문구보기</a>
										<div class="tooltip">
											<dl>
												<dt>* 도수치료</dt>
												<dd>
									...
									<div class="btn">
										<a href="#popSendEmail" class="btn-c1" onclick="clearMail(&quot;인터넷실손의료비보장보험1.0&quot;);" rel="history"><span>메일발송</span></a> <a href="#none" class="btn-c2" id="goPlan2" onclick="ga('send','event','Direct','Entry','medical-top_list_1',1);" rel="history"><span>가입하기</span></a> <input type="hidden" id="jsonResultData1" name="jsonResultData">
									</div>
					...
					<!-- 팝업링크 -->
					<div class="view-pop">
						<a href="#popProResult" class="link-type1" onclick="clickDetailTab(1);" rel="history"><span>보장내용보기</span></a> <a href="#popProResult" class="link-type1" onclick="clickDetailTab(2);" rel="history"><span>해지환급금</span></a>
					</div>
					<!-- //팝업링크 -->
					<!-- //이벤트 문구 삽입
            <div class="result-sms-event mes-type2">
               <p class="sub"><span class="on-icon"></span><em class="txt-c1">클릭! </em>가입 1건당 연탄 <em class="txt-c1">10장 기부!</em></p>
					...
					<div class="area-util">
						...
						<a href="#none" class="icon-util print" title="인쇄하기" id="doPrintNew" onclick="fn_printEntire();" rel="history">인쇄하기</a> <a href="#popSendEmail" class="icon-util email" title="이메일보내기" onclick="clearMail(&quot;인터넷실손의료비보장보험1.0&quot;);" rel="history">이메일보내기</a>
				...
				<div class="product-other none">
					<h3 class="heading2">
						<a href="#none" class="btnarea-curve" id="btnToggleAreaCurve" rel="history"><span class="btn-curve"></span><span class="txt-area">다른 고객님의 가입정보로<em>맞춤설계</em>를 해보세요
						</span></a>
					</h3>
					<div>
						<p class="mes-type1">
						...
						<div class="graph-data1">
							<dl>
								<dt>일반암</dt>
								<dd class="case1">
									<span>3천만원</span><em>66.4%</em> <img class="img-graph" src="/resources/web/images/product/pro1_other1.gif" alt="">
								</dd>
								<dd class="case2">
							...
							<dl>
								<dt>암사망</dt>
								<dd class="case1">
									<span>2천만원</span><em>27.0%</em> <img class="img-graph" src="/resources/web/images/product/pro1_other2.gif" alt="">
								</dd>
								<dd class="case2">
