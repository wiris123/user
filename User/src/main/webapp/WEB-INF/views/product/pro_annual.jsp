...
<body>
   ...
   <div class="product-basic page-change">
      ...
      <!-- CMS 영역 -->
      <div class="info">
         <h1><span>삼성생명</span><strong>인터넷연금보험</strong><em>1.5(무배당)</em></h1>
         <p class="com1"><strong>장기유지 보너스</strong>와 <br/><strong>비과세 혜택</strong>으로 더 많은 연금액!<br/>
            <span class="notice">(전금융사 합계 월납보험료 최대 150만원 한도, 관련세법 충족시)</span></p>
         <p class="com2"><span>이자수익에 대한 세금 15.4%까지 절약하여 연금으로 받으세요!</span>
            <span class="notice">(관련세법 충족시)</span></p>
      </div>
      ...
      <form action="#" id="formCalculator">
         <fieldset>
            ...
            <div class="calculator-form">
               <div class="heading">
                  <h2 class="cal-tit"><span>생년월일만으로</span><strong>빠르고 간편하게</strong></h2>
   ...
   <div class="product-result open" id="uiProductResult1" style="display:block;" tabindex="0">
      ...
      <div class="direct-planning">
         <div class="result-area">
            <h3><span class="blind">보험료 계산결과</span></h3>
               ...
               <fieldset>
                  ...
                  <div class="re-calculator-form">
                     <ul>
                        <!-- 연금개시나이 -->
                        <li>
                           <label for="annAge" class="re-cal-tit">연금개시나이</label>
                        ...
                        <!-- 납입기간 -->
                        <li>
                           <label for="napTerm" class="re-cal-tit">납입기간</label>
                           <span class="select-box">
                              <select id="napTerm">
                        ...
                        <!-- 납입금액 -->
                        <li>
                           <label for="napMoney" id="napMoneyExample" class="re-cal-tit">납입금액 10만원 이상</label>
                           <div class="input-wrap">
                              <input type="text" autocomplete="off" class="text placeholder numOnly" id="napMoney" value="30" maxlength="5" size="5" title="단위(만원)"/>
                              <span class="label">만원</span>
                           </div>
                        </li>
                        <li class="how-to-get">
                           <span class="re-cal-tit">수령방법</span>
                           <div class="tooltip-col">
                              <div class="tooltip-area">
                                 <span>종신연금형 <br />10회 보증</span>
                                 <a href="#none" class="icon-tip small" rel="history">종신연금형 10회 보증이란?</a>
                                 <div class="tooltip">
                                    <div>
                                       <p>종신연금형은 연금개시이후 피보험자가 사망하기 전까지 매년 일정한 연금액을 수령하는 형태입니다.</p><br />
                                       <p>또 다른 수령 형태인 확정연금형은 확정적으로 연금수령기간을 설정하며 연금수령기간 중 피보험자가 사망하여도 남은 연금금액을 지급하여 드리는 형태입니다.</p><br />
                     ...
                     <button type="button" class="re-calcul-btn" id="reCalcPremium2"><span>다시계산하기</span></button>
                  </div>
               </fieldset>
            </form>
         </div><!-- resultArea end -->
      </div><!-- direct-planning end -->
      </div><!-- resultTab end -->
